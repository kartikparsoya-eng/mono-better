...
_Remaining rust-ivm operators (join, fan_in/out, filter, skip, cap, union_*, source, view, builder/*, planner/*) are covered by the standing IVM differential oracle; spot-sweep of highest-risk push handlers ongoing._
