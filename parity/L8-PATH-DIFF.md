...
## cvr — 76 fn-pairs: 47 BOTH-HOT, 8 TS-HOT/RUST-COLD, 3 RUST-HOT/TS-COLD, 18 BOTH-COLD (traffic exercised 47/76)
...
## ivm — 215 fn-pairs: 89 BOTH-HOT, 24 TS-HOT/RUST-COLD, 21 RUST-HOT/TS-COLD, 81 BOTH-COLD (traffic exercised 89/215)

### ❌ TS-HOT/RUST-COLD

| TS symbol (file:line) | rust twin (file:line) | ts# | rust# | how |
|---|---|---|---|---|
| `assert` (builder/builder.ts:421) | `assert_matches` (replay.rs:703) | 38204 | 0 | fuzzy |
| `run` (query/query-delegate-base.ts:108) | `run` (query/query_delegate_base.rs:79) | 19427 | 0 | exact |
...
| `flush` (ivm/array-view.ts:173) | `flush` (ivm/array_view.rs:88) | 225 | 0 | exact |
...
| `stop` (ivm/stopable-iterator.ts:20) | `stop` (ivm/stopable_iterator.rs:23) | 132 | 0 | exact |
| `valuesEqual` (ivm/data.ts:112) | `values_equal` (ivm/data.rs:199) | 122 | 0 | exact |
...
| `clampTTL` (query/ttl.ts:89) | `clamp_ttl` (query/ttl.rs:42) | 99 | 0 | exact |
...
| TS symbol (file:line) | rust twin (file:line) | ts# | rust# | how |
|---|---|---|---|---|
| `data` (ivm/array-view.ts:111) | `data` (ivm/array_view.rs:74) | 0 | 112666 | exact |
...
| `NODE` (ivm/change-index-enum.ts:2) | `node` (ivm/change.rs:52) | 0 | 3376 | exact |
| `DEFAULT_TTL` (query/ttl.ts:19) | `default` (credit.rs:165) | 0 | 2130 | fuzzy |
| `cmp` (query/expression.ts:73) | `cmp` (ivm/source.rs:1477) | 0 | 1098 | exact |
...
| `makeAddChange` (ivm/change.ts:61) | `make_add_change` (ivm/change.rs:81) | 0 | 224 | exact |
...
| `makeSourceChangeAdd` (ivm/source.ts:22) | `make_source_change_add` (ivm/change.rs:126) | 0 | 20 | exact |
...
| `EditChange` (ivm/change.ts:57) | `push_edit_change` (ivm/take.rs:686) | 0 | 13 | fuzzy |
...
## syncer — 108 fn-pairs: 63 BOTH-HOT, 14 TS-HOT/RUST-COLD, 3 RUST-HOT/TS-COLD, 28 BOTH-COLD (traffic exercised 63/108)
...
| pair | ts# | rust# |
|---|---|---|
| `listIndexes` → `list_unique_indexes` | 9 | 5854 |


_full row set: parity/coverage/l8-rows-v2.json_
