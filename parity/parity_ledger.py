...
HELPER_ALIASES = {
    ...
    "zero-protocol/src/data.ts::rowSchema": ("protocol/data.rs Row", "valita readonlyRecord → serde_json::Map (D-17); rust-cvr's ensure_safe_json guards the same rows (F-CH-1)"),
    ...
    "zero-protocol/src/mutate-server.ts::mutateResponseSchema": ("protocol/mutate_server.rs MutateResponse", "valita union → untagged serde enum, passthrough mode (D-17)"),
    ...
    "zero-protocol/src/primary-key.ts::primaryKeySchema": ("protocol/primary_key.rs PrimaryKey", "valita tuple+array → non-empty Vec<String> newtype (D-17)"),
    ...
    "zero-protocol/src/primary-key.ts::primaryKeyValueRecordSchema": ("protocol/primary_key.rs PrimaryKeyValueRecord", "valita readonlyRecord → HashMap (D-17); rust-cvr make_row_patch keeps the Value form (client_handler.rs:741)"),
