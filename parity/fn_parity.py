...
CONFIRMED_FOLD = {
    ...
    "buildprimarykeys": "client_primary_keys_from_schema (view_syncer.rs:7897)",
    ...
    "runauthmaintenance": "run_auth_maintenance (view_syncer.rs:2026)",
    "scheduleauthmaintenance": "schedule_auth_maintenance (view_syncer.rs:1994)",
