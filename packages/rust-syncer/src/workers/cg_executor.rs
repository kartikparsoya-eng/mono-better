...
// service wiring it needs live in `services/view_syncer/view_syncer.rs`
// alongside the rest of the ViewSyncerService port; the executor spawns it
// back through these crate-internal imports.
