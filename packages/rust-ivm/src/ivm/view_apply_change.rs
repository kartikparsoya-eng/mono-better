//! applyChange — port of `zql/src/ivm/view-apply-change.ts`.
//!
//! Immutable view-tree maintenance: each `apply_change` path-copies the spine
//! from root to the changed node, keeping sibling references stable so unchanged
